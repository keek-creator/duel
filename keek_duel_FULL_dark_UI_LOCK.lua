...
openBtn.Draggable = not UI_LOCKED 
...
local frameUILock, btnUILock, strokeUILock, gradUILock, checkUILock =
    createFloatingBar("UILockBar", "UI LOCK: OFF", UDim2.new(0.45, 0, 0.60, 0))
...
btnUILock.MouseButton1Click:Connect(function()
    if not checkUILock() then return end
    UI_LOCKED = not UI_LOCKED
    setVisual(btnUILock, gradUILock, strokeUILock, UI_LOCKED, "UI LOCK: ON", "UI LOCK: OFF")
    openBtn.Draggable = not UI_LOCKED
end)
