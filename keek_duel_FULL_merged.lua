...
btnLock.MouseButton1Click:Connect(function()
    ...
    SafeFollow.Enabled = not SafeFollow.Enabled
    SafeFollow.Locked = SafeFollow.Enabled

    setVisual(btnLock, gradLock, strokeLock, SafeFollow.Enabled, "LOCK: ON", "LOCK: OFF")
end)
