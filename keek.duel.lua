...
local THEME = {
	...
	AccentDark = Color3.fromRGB(255, 0, 0),
	Text = Color3.fromRGB(255, 0, 0),
	DarkText = Color3.fromRGB(255, 0, 0),
	...
	ProgressBg = Color3.fromRGB(0, 0, 0),
...
local CONFIG_NAME, lastSaveTime, savedAnimate = "MoonHubConfig", 0, nil
local floatButtons = {}
...
local function updateToggleUI(name, state)
	...
	btn.state = state
	btn.track.BackgroundColor3 = state and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(60, 60, 60)
...
local function setupChar(c)
	...
	if head then
		...
		speedLbl.TextColor3 = Color3.fromRGB(255, 0, 0)
...
HUDTitle.Text = "keek duel" HUDTitle.TextColor3 = THEME.Accent
...
local MainStroke = Instance.new("UIStroke", Main) MainStroke.Color = THEME.Outline MainStroke.Thickness = 2
...
Title.Text = "keek duel" Title.TextColor3 = THEME.Accent Title.Font = Enum.Font.GothamBold
...
local function createToggle(name, keyHintPC, keyHintController, defaultState, callback, order)
	...
	Track.BackgroundColor3 = defaultState and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(60, 60, 60) Track.BorderSizePixel = 0
	...
	Btn.MouseButton1Click:Connect(function()
		...
		Track.BackgroundColor3 = ns and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(60, 60, 60)
...
local function createCombatKeybindBadge(parent, actionName)
	...
	badge.MouseButton1Click:Connect(function()
		...
		conn = UserInputService.InputBegan:Connect(function(input)
			...
			if input.UserInputType == Enum.UserInputType.Keyboard then
				KEYBINDS[actionName].PC = input.KeyCode
				badge.BackgroundColor3 = Color3.fromRGB(255, 0, 0) listeningForKeybind = nil
				saveConfig() syncKeybindDisplays(actionName) conn:Disconnect()
			end
		end)
...
createToggle("Moon Mode", "?", "?", galaxyEnabled, function(v)
